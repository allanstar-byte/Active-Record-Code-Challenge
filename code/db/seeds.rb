...
# ***********************************************************
# Create Roles Here
blondy = Role.create(salary: 200_000, character_name: "Blondy", actor: lindsay_lohan, movie: mean_girls)
blacky = Role.create(salary: 250_000, character_name: "Blacky", actor: lindsay_lohan, movie: spice_world)
eric = Role.create(salary: 270_000, character_name: "Eric", actor: baby_spice, movie: spice_world)
